...
internal class SafeMethods
{
    ...
    internal static extern bool ConnectNamedPipe(IntPtr hNamedPipe, [In] ref NativeOverlapped lpOverlapped);
    ...
    public static unsafe SP_DEVINFO_DATA* SetupDiGetClassDevsEx(
        Guid devInterfaceUsbHostControllerGuid,
        string? enumerator,
        IntPtr? hwndParent,
        DIGCF flags,
        SP_DEVINFO_DATA* deviceInfoSet,
