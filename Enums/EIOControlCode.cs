...
public enum EIOControlCode : uint
{
     ...
     StorageCheckVerify2 = (EFileDevice.MassStorage << 16) | (0x0200 << 2) | EMethod.Buffered | (0 << 14), // sFileAccess.Any
     ...
     StorageFindNewDevices = (EFileDevice.MassStorage << 16) | (0x0206 << 2) | EMethod.Buffered | (sFileAccess.Read << 14),
     ...
     StorageObsoleteResetBus = (EFileDevice.MassStorage << 16) | (0x0400 << 2) | EMethod.Buffered | (sFileAccess.ReadWrite << 14),
     StorageObsoleteResetDevice = (EFileDevice.MassStorage << 16) | (0x0401 << 2) | EMethod.Buffered | (sFileAccess.ReadWrite << 14),
     ...
     DiskSmartSendDriveCommand = (EFileDevice.Disk << 16) | (0x0021 << 2) | EMethod.Buffered | (sFileAccess.ReadWrite << 14),
     ...
     DiskSetCacheInformation = (EFileDevice.Disk << 16) | (0x0036 << 2) | EMethod.Buffered | (sFileAccess.ReadWrite << 14),
     ...
     DiskSetPartitionInfoEx = (EFileDevice.Disk << 16) | (0x0013 << 2) | EMethod.Buffered | (sFileAccess.ReadWrite << 14),
     ...
     ChangerGetElementStatus = (EFileDevice.Changer << 16) | (0x0005 << 2) | EMethod.Buffered | (sFileAccess.ReadWrite << 14),
     ChangerInitializeElementStatus = (EFileDevice.Changer << 16) | (0x0006 << 2) | EMethod.Buffered | (sFileAccess.Read << 14),
     ...
     ChangerReinitializeTarget = (EFileDevice.Changer << 16) | (0x000A << 2) | EMethod.Buffered | (sFileAccess.Read << 14),
     ChangerQueryVolumeTags = (EFileDevice.Changer << 16) | (0x000B << 2) | EMethod.Buffered | (sFileAccess.ReadWrite << 14),
     // FILESYSTEM
